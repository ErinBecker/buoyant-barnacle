...
## Challenge 3: sessionInfo()

Use sessionInfo() to print the session information of your R instance.
...
loaded via a namespace (and not attached):
 [1] compiler_4.1.0       magrittr_2.0.1       assertthat_0.2.1    
 [4] tools_4.1.0          stringi_1.6.2.9004   knitr_1.33          
 [7] stringr_1.4.0        xfun_0.23            evaluate_0.14       
[10] sandpaper_0.0.0.9027
```
